...
std::vector<float> make_transverse_vector(std::vector<float> mom){
	...
	std::vector<float> transverse_momentum({mom[0] - (mom_unit_dot_prod)*long_unit_vector[0], mom[1] - (mom_unit_dot_prod)*long_unit_vector[1], mom[2] - (mom_unit_dot_prod)*long_unit_vector[2]});
...
int main(){
	...
	while(my_reader.Next()){
		...
		lambda_t_momentum_dist->Fill(trans_mom_mag);
